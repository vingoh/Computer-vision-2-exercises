...
if nargin < 2  %nargin: number of input parameters
    mode = 'newplot';
end
...
str = fscanf(file,'%s',1);  %  %s is the type of data, stands for string

% Check Prefix
if strcmp(str, 'OFF') == false %string compare
